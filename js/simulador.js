    ...
    <div class="sim-module" id="${id}">
      ...
      <div class="sim-module__body">
        ...
        <div class="sim-col-right">
          ...
          <p class="sim-legal-text">
            Simulacion orientativa sujeta a aprobacion financiera, condiciones contractuales y verificacion documental previa.
          </p>
